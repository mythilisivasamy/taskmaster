...
export class SignupComponent {
  constructor(private ts: TaskService, private builder: FormBuilder,private router:Router) {}
  ...
  userForm: FormGroup = this.builder.group({
    ...
    email: ['', [Validators.required, emailValidator(/^[a-zA-Z0-9+_.-]+@[a-zA-Z0-9.-]+$/)]],
  ...
  signup() {
    ...
    this.ts.signup(this.user).subscribe(() => {
